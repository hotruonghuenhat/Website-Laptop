...
<head>
   ...
   <style>
   body{
      background-image: url("https://img.freepik.com/premium-vector/pastel-colored-ice-cream-sprinkles-seamless-pattern-background-flat-vector-illustration_91515-273.jpg?w=2000");
   }
</style>
   ...
   <section class="contact">
      ...
      <div class="row">
         ...
         <form action="" method="post">
            ...
            <h4 style="background-color: white;"></h4>
         </form>
